...
import './index.css';
import ListaConvocacoes from './pages/Agenda/EventoConvocacao/DetalheEventoConvocacao.jsx'
    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route path="/convocacoes" element={<RotaProtegida><ListaConvocacoes /></RotaProtegida>} />
        </Routes>
      </div>
    </Router>
  );
