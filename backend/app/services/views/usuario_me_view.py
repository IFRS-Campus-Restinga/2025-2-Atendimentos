...
#
#        if tipo == TipoUsuario.COORDENADOR:
#            COORDENADORES_PERMITIDOS = ["coord1@dominio.com", "coord2@dominio.com"]
#            if email.lower() not in [e.lower() for e in COORDENADORES_PERMITIDOS]:
#                return Response(
#                    {"email": "Este e-mail não está autorizado como coordenador."},
#                    status=status.HTTP_400_BAD_REQUEST
#                )
#
#        if tipo == TipoUsuario.ADMINISTRADOR:
#            ADMINISTRADORES_PERMITIDOS = ["admin1@dominio.com", "admin2@dominio.com"]
#            if email.lower() not in [e.lower() for e in ADMINISTRADORES_PERMITIDOS]:
#                return Response(
#                    {"email": "Este e-mail não está autorizado como administrador."},
#                    status=status.HTTP_400_BAD_REQUEST
#                )
#
#        User = get_user_model()
...
#            usuario_data['matricula'] = matricula
#            usuario_data['curso_id'] = curso_id
#        # Coordenador e Administrador não têm campos extras além da validação
#
#        try:
#            usuario = Usuario.objects.get(user=auth_user)
